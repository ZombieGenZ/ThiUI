  ...
  return (
    <div className="min-h-screen bg-white">
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.pexels.com/photos/1743229/pexels-photo-1743229.jpeg?auto=compress&cs=tinysrgb&w=1920)',
        }}
      >
        <div className="absolute inset-0 bg-black/50" />
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
          <div>
            <h1 className="font-serif text-5xl text-white mb-4">Bedroom</h1>
            <p className="text-xl text-white/90">Create your perfect sanctuary</p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="group relative bg-white rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <div className="relative aspect-square overflow-hidden bg-gray-100">
        ...
        <img
          src={product.images[0] || 'https://images.pexels.com/photos/1743229/pexels-photo-1743229.jpeg'}
          alt={product.name}
