    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
          <div>
            <h1 className="font-display text-5xl text-white mb-4">Dining</h1>
            <p className="text-xl text-white/90">Gather around in style</p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="group relative bg-white rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <div className="relative aspect-square overflow-hidden bg-gray-100">
        ...
        <img
          src={product.images[0] || 'https://images.pexels.com/photos/1395967/pexels-photo-1395967.jpeg'}
          alt={product.name}
