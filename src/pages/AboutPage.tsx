    ...
    <div className="min-h-screen bg-white">
      <div className="relative h-96 bg-gradient-to-r from-neutral-900 to-neutral-700">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
          <div>
            <h1 className="font-display text-5xl text-white mb-4">About FurniCraft</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div data-aos="fade-right">
            ...
            <p className="text-neutral-600 leading-relaxed mb-4">
              FurniCraft was founded with a simple mission: to make high-quality, beautifully designed furniture
        ...
        <div className="bg-neutral-100 rounded-xl p-12" data-aos="fade-up">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-neutral-600 leading-relaxed mb-8">
              At FurniCraft, we're more than just a furniture store. We're a community of design enthusiasts,
